  ...
  const supportPrograms = [
    {
      ...
      bgImage: "/images/logo/gettyimages-1344964565-612x612.jpg" // replace with your path
    },
    {
      title: "Creative Arts",
      ...
      icon: <Star />,
      bgColor: "bg-teal-600",
      bgImage: "/images/logo/istockphoto-1440778816-612x612.webp"
    },
    {
      ...
      icon: <Target />,
      bgColor: "bg-orange-500",
      bgImage: "/images/logo/photo-1666713918240-f069b98957b6.avif"
    },
    {
      ...
      icon: <HandHeart />,
      bgColor: "bg-teal-500",
      bgImage: "/images/logo/premium_photo-1667219556197-8f7e0db9c186.avif"
    }
  ];
...
<Link to='/get-involved/contact'>
  <button className={`inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r mt-1 ${program.color} text-white font-semibold rounded-lg sm:rounded-xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 text-sm sm:text-base`}>
                  ...
                  <div className="relative order-first lg:order-none flex justify-center items-center">
                    <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 lg:w-full lg:h-80 xl:h-96 rounded-xl sm:rounded-2xl shadow-lg overflow-hidden bg-white p-2">
                      <img 
                        src={program.image} 
                        alt={program.title}
...
//       description: "Strategically located centers in Mumbai and Thane slum areas, mobilizing local underprivileged children and providing foundational educational courses. Our grassroots approach ensures direct community impact and sustainable development.",
//       longDescription: "These centers serve as beacons of hope in underserved communities, offering a safe learning environment where children can access quality education, nutritious meals, and mentorship. Each center is staffed with trained educators and volunteers who understand the local context and challenges.",
//       image: "/images/logo/istockphoto-1740994754-612x612.webp", // Replace with your actual image path
//       beneficiaries: "500+ Children",
//       locations: "12 Centers",
//       features: [
//         "Daily educational activities",
...
//       description: "Dedicated schools for street children, ensuring no child is left behind in their educational journey. Providing comprehensive basic education with a focus on rehabilitation and integration into mainstream society.",
//       longDescription: "Recognizing that street children face unique challenges, our specialized schools provide not just education but also psychological support, healthcare, and life skills training. We work towards complete rehabilitation and social integration.",
//       image: "/images/logo/gettyimages-535555239-612x612.jpg", // Replace with your actual image path
//       beneficiaries: "200+ Street Children",
//       locations: "Planning Phase",
//       features: [
//         "Flexible learning schedules",
...
//                   {/* Image Section - Now displays full image */}
//                   <div className="relative order-first lg:order-none">
//                     <div className="aspect-square rounded-xl sm:rounded-2xl shadow-lg overflow-hidden">
//                       <img 
//                         src={program.image} 
//                         alt={program.title}
