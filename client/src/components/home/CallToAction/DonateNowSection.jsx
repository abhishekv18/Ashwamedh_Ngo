...
const CallToAction = () => {
  return (
    <section className="relative py-12 sm:py-14 lg:py-16" style={{ background: 'linear-gradient(135deg, #FFF3E0 0%, #FFF8F5 100%)' }}>
      {/* Background Pattern */}
...
<Link to='/get-involved/volunteer'>
 <button 
        ...
        <div 
          className="text-center bg-white rounded-2xl sm:rounded-3xl shadow-xl p-5 sm:p-6 lg:p-10 border-l-4 sm:border-l-8"
        ...
        >
          <div className="flex justify-center items-center flex-wrap gap-6 sm:gap-8 lg:gap-12 mb-8 sm:mb-10">
            ...
            <div className="w-px h-12 sm:h-14 lg:h-16 bg-gray-300 hidden sm:block"></div>
            <div className="text-center">
              <div className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 sm:mb-3" style={{ color: '#FFC107' }}>13+</div>
...
// const CallToAction = () => {
//   return (
//     <section className="relative py-8 sm:py-12 lg:py-14" style={{ background: 'linear-gradient(135deg, #FFF3E0 0%, #FFF8F5 100%)' }}>
//       {/* Background Pattern */}
//       <div className="absolute inset-0 opacity-5">
//         <div className="h-full w-full bg-repeat" style={{
...
//           <div 
//             className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 rounded-full mb-4 sm:mb-6 shadow-lg"
//             style={{ background: 'linear-gradient(135deg, #FF5722 0%, #FF7043 100%)' }}
//           >
//             <HandHeart className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
//           </div>
//           <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6" style={{ color: '#212121' }}>
//             Be the Change You Want to See
//           </h2>
//           <p className="text-base sm:text-lg max-w-3xl mx-auto leading-relaxed" style={{ color: '#616161' }}>
//             Every child deserves a chance to dream, learn, and thrive. Your support can transform lives 
//             and build a brighter future for India's children.
//           </p>
//         </div>
...
//         {/* CTA Cards */}
//         <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 sm:gap-6 lg:gap-8 mb-8 sm:mb-12">
//           {/* Donate Card */}
//           <div className="group relative bg-white rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden border border-gray-100">
//             <div 
...
//                 <div 
//                   className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center mb-3 sm:mb-0 sm:mr-4 group-hover:scale-105 transition-all duration-300 shadow-md"
//                   style={{ backgroundColor: '#FFF3E0' }}
//                 >
//                   <Heart className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#FF5722' }} />
//                 </div>
//                 <div>
//                   <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-1" style={{ color: '#212121' }}>Make a Donation</h3>
//                   <p className="font-semibold text-sm sm:text-base" style={{ color: '#FF5722' }}>Every rupee counts</p>
//                 </div>
//               </div>

//               <p className="text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed" style={{ color: '#616161' }}>
//                 Your donation provides education, healthcare, and hope to children in need. 
//                 Join thousands of supporters making a real difference.
//               </p>
...
//               {/* Impact Stats */}
//               <div 
//                 className="grid grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6 p-3 sm:p-4 rounded-lg border-2"
//                 style={{ backgroundColor: '#FFF8F5', borderColor: '#FFE0B2' }}
//               >
//                 <div className="text-center">
//                   <div className="text-lg sm:text-xl lg:text-2xl font-bold mb-1" style={{ color: '#FF5722' }}>₹500</div>
//                   <div className="text-xs sm:text-sm font-medium" style={{ color: '#757575' }}>Feeds a child for a month</div>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-lg sm:text-xl lg:text-2xl font-bold mb-1" style={{ color: '#FF5722' }}>₹2000</div>
//                   <div className="text-xs sm:text-sm font-medium" style={{ color: '#757575' }}>School supplies for a year</div>
//                 </div>
//               </div>
...
//               <Link to='/get-involved/donate'>
//                 <button 
//                   className="w-full font-bold py-2 sm:py-3 px-4 rounded-lg transition-all duration-300 flex items-center justify-center group-hover:shadow-md text-white text-sm sm:text-base hover:scale-[1.02] transform"
//                   style={{ 
//                     background: 'linear-gradient(135deg, #FF5722 0%, #E64A19 100%)',
...
//                   style={{ backgroundColor: '#E0F2F1' }}
//                 >
//                   <Users className="w-5 h-5 sm:w-6 sm:h-6" style={{ color: '#00695C' }} />
//                 </div>
//                 <div>
//                   <h3 className="text-lg sm:text-xl lg:text-2xl font-bold mb-1" style={{ color: '#212121' }}>Join as Volunteer</h3>
//                   <p className="font-semibold text-sm sm:text-base" style={{ color: '#00695C' }}>Your time, their future</p>
//                 </div>
//               </div>
...
//                 <div 
//                   className="flex items-center p-2 sm:p-3 rounded-md border-l-4 transition-all duration-300 hover:shadow-sm"
//                   style={{ backgroundColor: '#E0F2F1', borderLeftColor: '#00695C' }}
//                 >
//                   <div className="w-2 h-2 rounded-full mr-2 sm:mr-3" style={{ backgroundColor: '#00695C' }}></div>
//                   <span className="font-medium text-sm sm:text-base" style={{ color: '#424242' }}>Teaching & Mentoring</span>
//                 </div>
//                 <div 
//                   className="flex items-center p-2 sm:p-3 rounded-md border-l-4 transition-all duration-300 hover:shadow-sm"
...
//         {/* Bottom Impact Message */}
//         <div 
//           className="text-center bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border-l-4"
//           style={{ borderLeftColor: '#FF5722' }}
//         >
//           <div className="flex justify-center items-center flex-wrap gap-4 sm:gap-6 mb-4 sm:mb-6">
//             <div className="text-center">
//               <div className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2" style={{ color: '#FF5722' }}>5000+</div>
//               <div className="font-semibold text-xs sm:text-sm" style={{ color: '#757575' }}>Children Helped</div>
//             </div>
//             <div className="w-px h-10 sm:h-12 bg-gray-300 hidden sm:block"></div>
//             <div className="text-center">
//               <div className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2" style={{ color: '#00695C' }}>20+</div>
//               <div className="font-semibold text-xs sm:text-sm" style={{ color: '#757575' }}>Active Volunteers</div>
//             </div>
//             <div className="w-px h-10 sm:h-12 bg-gray-300 hidden sm:block"></div>
//             <div className="text-center">
//               <div className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2" style={{ color: '#FFC107' }}>15+</div>
//               <div className="font-semibold text-xs sm:text-sm" style={{ color: '#757575' }}>Years of Impact</div>
//             </div>
//           </div>
          
//           <div 
//             className="max-w-3xl mx-auto p-3 sm:p-4 rounded-lg"
//             style={{ backgroundColor: '#FFF8F5' }}
//           >
//             <blockquote className="text-sm sm:text-base lg:text-lg font-medium italic leading-relaxed mb-2 sm:mb-3" style={{ color: '#424242' }}>
//               "The best way to find yourself is to lose yourself in the service of others."
//             </blockquote>
//             <cite className="text-xs sm:text-sm font-semibold not-italic" style={{ color: '#FF5722' }}>
//               - Mahatma Gandhi
//             </cite>
//           </div>
//         </div>
