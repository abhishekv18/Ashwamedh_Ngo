...
//               <h3 className="text-sm sm:text-base font-semibold text-gray-800 mb-3 sm:mb-3 uppercase tracking-wide">
//                 Select Projects
//               </h3>
...
//                     <button
//                       onClick={() => toggleProject(project.name)}
//                       className={`flex items-center justify-between w-full p-2 sm:p-3 rounded-lg border-2 transition-all duration-200 ${
//                         selectedProjects.includes(project.name)
//                           ? 'border-teal-500 bg-teal-50 text-teal-700'
//                           : 'border-gray-200 bg-white text-gray-600 hover:border-gray-300'
//                       }`}
...
//                       )}
//                     </button>
//                     <div className="mt-2 sm:mt-2 ml-1 sm:ml-2">
...
//             {/* Stats */}
//             <div className="grid grid-cols-2 gap-3 sm:gap-3 pt-3 sm:pt-4 border-t border-gray-200">
//               <div className="text-center">
//                 <div className="text-lg sm:text-lg font-bold text-orange-600">1</div>
//                 <div className="text-xs sm:text-xs text-gray-600">Active City</div>
//               </div>
//               <div className="text-center">
//                 <div className="text-lg sm:text-lg font-bold text-teal-600">4</div>
//                 <div className="text-xs sm:text-xs text-gray-600">Programs Running</div>
//               </div>
//             </div>
//           </div>
...
//                 </h3>
//                 <div className="bg-orange-100 text-orange-600 px-2 sm:px-3 py-1 sm:py-1 rounded-full text-xs sm:text-xs font-medium self-start sm:self-auto">
//                   1 Active City
//                 </div>
//               </div>

//               {/* Map Container */}
//               <div className="relative bg-gradient-to-br from-yellow-100 to-orange-100 rounded-lg sm:rounded-xl p-3 sm:p-4 min-h-48 sm:min-h-64 overflow-hidden">
//                 {/* Maharashtra Map SVG */}
//                 <svg viewBox="0 0 400 300" className="w-full h-full">
//                   {/* Maharashtra outline */}
//                   <path
...
//                         r="6" 
//                         fill="#00695C"
//                         className="animate-pulse drop-shadow-lg sm:r-8"
//                       />
//                       <circle 
//                         cx={location.lat} 
//                         cy={location.lng} 
...
//                         strokeWidth="2"
//                         opacity="0.5"
//                         className="animate-ping sm:r-12"
//                       />
//                       <text 
//                         x={location.lat + 12} 
//                         y={location.lng + 4} 
//                         className="text-xs sm:text-xs font-bold fill-gray-800 drop-shadow-sm"
//                       >
//                         {location.name}
//                       </text>
//                       <text 
...
//                   {/* Legend */}
//                   <g transform="translate(8, 8)">
//                     <rect x="0" y="0" width="120" height="80" fill="white" stroke="#E0E0E0" rx="6" className="drop-shadow-md" />
//                     <circle cx="12" cy="20" r="4" fill="#00695C" className="sm:cx-15 sm:cy-25 sm:r-6" />
//                     <text x="20" y="24" className="text-xs fill-gray-700 font-medium sm:x-25 sm:y-29">Active City</text>
//                     <rect x="10" y="30" width="12" height="8" fill="#FFC107" stroke="#FF8F00" className="sm:x-12 sm:y-35 sm:width-15 sm:height-10" />
//                     <text x="24" y="37" className="text-xs fill-gray-700 sm:x-30 sm:y-43">Maharashtra</text>
//                     <text x="10" y="50" className="text-xs fill-orange-600 font-bold sm:x-12 sm:y-58">Project Ankur</text>
//                     <text x="10" y="60" className="text-xs fill-teal-600 font-bold sm:x-12 sm:y-70">Project Aakaar</text>
//                   </g>
//                 </svg>
//               </div>

//               {/* Location Details */}
//               <div className="mt-3 sm:mt-4 space-y-2 max-h-40 sm:max-h-48 overflow-y-auto">
//                 {getVisibleLocations().map((location) => (
//                   <div key={location.name} className="bg-gray-50 rounded-lg p-2 sm:p-3">
//                     <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-1 gap-1">
//                       <div className="flex items-center space-x-2 sm:space-x-2">
//                         <div className="w-2 h-2 sm:w-3 sm:h-3 bg-teal-500 rounded-full flex-shrink-0"></div>
//                         <span className="font-bold text-gray-900 text-sm sm:text-sm">{location.name}</span>
//                         <span className="text-xs text-gray-500">Pop: {location.population}</span>
//                       </div>
//                       <div className="text-xs font-medium text-orange-600 ml-3 sm:ml-0">
//                         {location.activePrograms} Active Programs
//                       </div>
//                     </div>
//                     <div className="flex items-center text-xs text-gray-500 mb-1 ml-4 sm:ml-4">
//                       <span className="mr-1">Centers:</span>
//                       <span className="font-medium">{location.centers}</span>
//                     </div>
//                     <div className="flex flex-wrap gap-1 sm:gap-1 ml-4 sm:ml-4">
//                       {location.projects.filter(project => selectedProjects.includes(project)).map((project) => {
//                         const projectConfig = projects.find(p => p.name === project);
//                         return (
//                           <div key={project} className={`flex items-center space-x-1 ${projectConfig?.color} text-white px-2 py-1 rounded-full text-xs`}>
//                             {projectConfig?.icon}
//                             <span className="font-medium">{project.replace('Project ', '')}</span>
//                           </div>
//                         );
...
//           <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-xl p-3 sm:p-4 lg:p-5 border border-white/20 hover:scale-105 transition-transform duration-200">
//             <div className="flex items-center space-x-2 sm:space-x-2 mb-2 sm:mb-2">
//               <div className="w-7 h-7 sm:w-8 sm:h-8 bg-orange-500 rounded-lg flex items-center justify-center text-white flex-shrink-0">
//                 <Star className="w-3 h-3 sm:w-4 sm:h-4" />
//               </div>
//               <h3 className="text-base sm:text-base font-bold text-white">Project Ankur</h3>
//             </div>
//             <p className="text-orange-100 mb-2 text-xs sm:text-xs">
//               "Catch them young" - Our early childhood development program focusing on foundational education, nutrition, and holistic child development.
//             </p>
//             <Link to='/what-we-do/projects'>
//               <button className="bg-orange-500 hover:bg-orange-600 text-white px-2 sm:px-3 py-1 sm:py-1 rounded-lg font-semibold transition-colors duration-200 text-xs sm:text-xs">
//                 Learn More About Ankur
//               </button>
//             </Link>
//           </div>
...
//           <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-xl p-3 sm:p-4 lg:p-5 border border-white/20 hover:scale-105 transition-transform duration-200">
//             <div className="flex items-center space-x-2 sm:space-x-2 mb-2 sm:mb-2">
//               <div className="w-7 h-7 sm:w-8 sm:h-8 bg-teal-500 rounded-lg flex items-center justify-center text-white flex-shrink-0">
//                 <Target className="w-3 h-3 sm:w-4 sm:h-4" />
//               </div>
//               <h3 className="text-base sm:text-base font-bold text-white">Project Aakaar</h3>
//             </div>
//             <p className="text-orange-100 mb-2 text-xs sm:text-xs">
//               Our comprehensive personality development course designed to build confidence, life skills, and character among children and youth.
//             </p>
//             <Link to='/what-we-do/projects'>
//               <button className="bg-teal-500 hover:bg-teal-600 text-white px-2 sm:px-3 py-1 sm:py-1 rounded-lg font-semibold transition-colors duration-200 text-xs sm:text-xs">
//                 Learn More About Aakaar
//               </button>
//             </Link>
//           </div>
...
//         {/* Call to Action */}
//         <div className="mt-6 sm:mt-8 bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-xl p-3 sm:p-4 lg:p-5 border border-white/20 text-center">
//           <h3 className="text-lg sm:text-lg font-bold text-white mb-2 sm:mb-2">Join Our Mission in Vasai</h3>
//           <p className="text-orange-100 text-xs sm:text-xs mb-2 sm:mb-3">
//             Help us expand Project Ankur and Project Aakaar to reach more children in Vasai through our 2 centers
//           </p>
//           <div className="flex flex-col sm:flex-row gap-2 sm:gap-2 justify-center">
//             <Link to='/get-involved/donate'>
//               <button className="bg-white text-orange-600 px-3 sm:px-3 py-1 sm:py-1 rounded-lg font-semibold hover:bg-orange-50 transition-colors duration-200 shadow-lg text-xs sm:text-xs">
//                 Support Our Projects
//               </button> 
//             </Link>
//             <Link to='/get-involved/volunteer'>
//               <button className="bg-transparent border border-white text-white px-3 sm:px-3 py-1 sm:py-1 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition-colors duration-200 text-xs sm:text-xs">
//                 Become a Volunteer
//               </button>
//             </Link>
//           </div>
