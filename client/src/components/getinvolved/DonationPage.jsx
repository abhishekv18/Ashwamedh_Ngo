...
//     qrCodeImage: "/public/images/qr-code.png" // Replace with actual QR code image
//   };
...
// //   // Fetch city and state for valid 6-digit pincode
...
//   // If pincode is being cleared or has less than 6 digits
//   if (field === 'pincode' && value.length < 6) {
//     setFormData(prev => ({
//       ...prev,
//       city: '',
...
//               <h3 className="text-xl font-bold mb-4">Secure Payment Gateway</h3>
//               <p className="mb-4">Complete your donation using our secure payment gateway with multiple options:</p>
...
//                 className="w-full py-4 px-6 bg-orange-600 hover:bg-orange-700 text-white font-bold rounded-lg transition-all hover:shadow-lg"
//               >
//                 Pay ₹{getCurrentAmount().toLocaleString('en-IN')} via Payment Gateway
//               </button>
//             </div>
//             <div className="bg-orange-50/90 p-4 rounded-lg border border-orange-200">
...
//           <div className="space-y-6">
//             <div className="bg-white/90 p-6 rounded-xl shadow-sm">
//               <h3 className="text-xl font-bold mb-4">Direct UPI Transfer</h3>
//               <p className="mb-4">You can transfer your donation directly to our UPI ID:</p>
              
//               <div className="bg-orange-50 p-4 rounded-lg mb-6">
//                 <div className="flex items-center justify-between">
//                   <div>
//                     <p className="text-sm text-gray-600">UPI ID</p>
//                     <p className="text-xl font-bold text-orange-700">{bankDetails.upiId}</p>
//                   </div>
//                   <button 
...
//           <div className="space-y-6">
//             <div className="bg-white/90 p-6 rounded-xl shadow-sm">
//               <h3 className="text-xl font-bold mb-4">Scan QR Code to Donate</h3>
//               <p className="mb-4">Scan the QR code below using any UPI app to make your donation:</p>
...
//               <p className="mb-6">You can transfer your donation directly to our bank account:</p>
              
//               <div className="space-y-4 mb-6">
//                 <div className="bg-orange-50 p-4 rounded-lg">
//                   <p className="text-sm text-gray-600">Account Name</p>
//                   <p className="text-lg font-bold text-orange-700">{bankDetails.accountName}</p>
//                 </div>
                
//                 <div className="grid md:grid-cols-2 gap-4">
//                   <div className="bg-orange-50 p-4 rounded-lg">
//                     <p className="text-sm text-gray-600">Account Number</p>
//                     <p className="text-lg font-bold text-orange-700">{bankDetails.accountNumber}</p>
//                   </div>
                  
//                   <div className="bg-orange-50 p-4 rounded-lg">
//                     <p className="text-sm text-gray-600">IFSC Code</p>
//                     <p className="text-lg font-bold text-orange-700">{bankDetails.ifsc}</p>
//                   </div>
//                 </div>
                
//                 <div className="bg-orange-50 p-4 rounded-lg">
//                   <p className="text-sm text-gray-600">Bank Name & Branch</p>
//                   <p className="text-lg font-bold text-orange-700">{bankDetails.bankName}, {bankDetails.branch}</p>
//                 </div>
//               </div>
