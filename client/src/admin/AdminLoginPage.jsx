...
const AdminLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="fixed top-0 left-0 w-full bg-white/80 backdrop-blur-md shadow-md border-b border-gray-200 z-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3 cursor-pointer group">
              <Link to="/">
                <div className="bg-gradient-to-t from-orange-50 to-white p-1.5 rounded-lg group-hover:shadow-lg transition-all duration-300">
                  <img
                    src="/images/logo/9c2ddc63-1fba-41bf-a057-3857806468e2-removebg-preview.png"
            ...
            <Link to="/">
              <button className="flex items-center space-x-2 text-gray-600 hover:text-orange-600 transition-colors px-2 py-1 rounded-md hover:bg-gray-50">
      ...
      {/* Main Content */}
      <div className="flex flex-col lg:flex-row min-h-screen pt-6 lg:pt-13">
        {/* Left Section (Image) */}
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-400 via-orange-500 to-orange-600 relative overflow-hidden">
            ...
            <div className="max-w-md text-center">
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-center space-x-3 bg-white bg-opacity-10 p-4 rounded-lg backdrop-blur-sm">
                  <Users className="h-6 w-6 text-orange-200 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-center space-x-3 bg-white bg-opacity-10 p-4 rounded-lg backdrop-blur-sm">
                  <Heart className="h-6 w-6 text-orange-200 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-base">Program Oversight</h3>
        ...
        {/* Right Section (Form) */}
        <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-white min-h-screen lg:min-h-auto">
          <div className="w-full max-w-sm sm:max-w-md md:max-w-lg">
            <div className="text-center mb-6">
              <div className="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full mb-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.email}
                    onChange={handleInputChange}
                    className="block w-full pl-10 pr-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-900 placeholder-gray-500 text-sm"
                    placeholder="admin@ashwamedhfoundation.org"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    value={formData.password}
                    onChange={handleInputChange}
                    className="block w-full pl-10 pr-10 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 text-gray-900 placeholder-gray-500 text-sm"
                    placeholder="Enter your password"
                  />
                  <button
                    type="button"
